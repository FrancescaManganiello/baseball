...
class DAO():
    ...
    # Permettere all’utente di selezionare da un apposito  menu a tendina il valore di un anno di campionato,
    # tra quelli disponibili nel database (teams.year), a partire dal 1980
   ...
   # Si dovrà stampare il numero di teams che ha giocato in tale anno, e l’elenco delle rispettive sigle
   @staticmethod
